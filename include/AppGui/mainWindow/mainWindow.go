...
func NewGuiComponent()*appStruct.GuiComponent{
	...
	guiC.FileProgress = widgets.NewQProgressBar(nil)
	...
	guiC.StartDirectoryForScan  = widgets.NewQLabel2("",nil,0)
	guiC.InfoAboutScanningFiles  = widgets.NewQLabel2("",nil,0)
	guiC.ScanningTimeInfo  = widgets.NewQLabel2("",nil,0)
	//
